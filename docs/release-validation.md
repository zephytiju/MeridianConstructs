...
| `createClickHouseTelemetryPlan`, `telemetryFields`                                                                  | Exact public layouts, complete V1 field mapping and canonical identities; caller-owned scope, TLS, secrets and migration; selected Adapter batch bounds; stock component/lambda requirements; installed-package real-plugin, public-read and recovery gates.                                     |
