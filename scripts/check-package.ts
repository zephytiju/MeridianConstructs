...
if (
  ...
  throw new Error(
    "The repository must publish only @zephytiju/meridian-storage-constructs@1.6.1",
  );
}
...
for (const required of [
  ...
  "docs/collector-clickhouse.md",
  "dist/constructs/otel/exporters/clickhouse/index.js",
  "dist/index.d.ts",
  "dist/index.js",
